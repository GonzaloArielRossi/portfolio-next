      ...
      <footer className="--footer has-background-primary">
        ...
        >
          <div className="columns is-gapless --flex-gap-2">
            ...
            <Link
              className="has-text-weight-bold column --flex-basis has-text-light "
              href="mailto:gonzaloarielrossi@gmail.com?subject=Contact%20via%20gonzalorossi.dev"
              rel="noreferrer"
              target="_blank"
            >
              <span className="--hover-color-alt">
            ...
            <Link
              ...
              target="_blank"
            >
              <span className="--hover-color-alt">📞 (+54) 9 11-3033-4862</span>
            </Link>
          </div>
          ...
          <div className="is-flex mb-4 is-align-items-center">
            <Link
              ...
              target="_blank"
            >
              <AiFillLinkedin className="--icon mr-4 --hover-color-alt" />
            </Link>
            <Link
              className="is-flex is-align-items-center"
              ...
              target="_blank"
            >
              <AiFillGithub className="--icon --hover-color-alt" />
            </Link>
          </div>
